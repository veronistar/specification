...
\begin{itemize}
    ...
    \item Data type names and namespace names are case-sensitive.\footnote{%Names that differ only in letter case are not permitted because that may cause name collisions within case-insensitive file systems.}

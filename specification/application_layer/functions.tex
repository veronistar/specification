...
% Would be better restated in active voice "\DSDLReference{uavcan.time.GetSynchronizationMasterInfo} is an important service type designed to provide nodes with information about the currently used time system and related data such as the number of leap seconds."
